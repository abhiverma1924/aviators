...
<div class="row">
<div class="col-lg-6">
<span class="logo"><a href="../index.html">AVIATION</a></span></div>
<?php
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        </li><li class="pull-right"> <a href="logout.php?q=connect.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Signout</a></li>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="tag"></label>
  <div class="col-md-12">
  <label for"#file">Select answer file.</label>
